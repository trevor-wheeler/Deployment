  ...
  return (
    <>
      <div className="profile">
        ...
        <div className="links">
          <a className="active" href="https://www.github.com/trevor-wheeler/" target="_blank"><i className="bi bi-github"></i></a>
      ...
      <div ref={page} className="projects">
        <div className="accent project">
          ...
          <div className="project-links">
            <a href="https://github.com/trevor-wheeler/MIDI-Piano" target="_blank"><i className="bi bi-github"></i></a>
...
function Contact() {
  ...
  const onSubmit = email => {
    ...
    axios.post('/portfolio/api/sendmail', email, config);
